...
+ [チュートリアル — SOAP APIの使用](/help/tutorial-use-soap-apis/introduction.md)
+ [手順1 - SOAP APIの概要](/help/tutorial-use-soap-apis/get-started-with-soap-apis.md)
+ [手順2 — 受信者と記事を追加してSOAP APIリクエストを使用する](/help/tutorial-use-soap-apis/add-recipients-and-articles-using-soap-api-requests.md)
+ [手順3 - SOAP APIを使用してユーザーを購読する](/help/tutorial-use-soap-apis/subscribe-users-via-soap-api.md)
