...
+ [チュートリアル — Campaign SOAP APIの使用](/help/tutorial-using-soap-apis/introduction.md)
...
+ 手順4 — 購読者向けの「新しい記事アラート」Eメール配信を作成する{#article-alert-email}
   + [購読者向けの「新しい記事アラート」Eメール配信の作成](/help/tutorial-using-soap-apis/create-article-alert-email-overview.md)
