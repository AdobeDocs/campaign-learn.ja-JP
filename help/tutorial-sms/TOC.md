...
+ チュートリアルに戻る {#campaign-tutorials}
   + [Adobe Campaign v8 チュートリアル](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/overview.html?lang=ja)
   + [Adobe Campaign v7 チュートリアル](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/overview.html?lang=ja)
