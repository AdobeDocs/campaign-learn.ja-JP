...
* 新規購読者にウェルカムメールを送信します。
   * ウェルカムメールは、新しいコンテンツがメール購読者に唐突に届き、登録解除されたり、スパムメールとしてマークされたりするのを防ぐことに役に立ちます。
...
残念ながら、メール疲れを感じているメール購読者のほとんどは、皆さんにとって頭痛の種になります。 購読者自身が登録を解除することは、コンテンツに満足していないという明確な意思表示になりますが、登録解除をしない場合があります。 多くの購読者はただメールを削除するか無視するだけなので、実際にはエンゲージメントがないにもかかわらず購読者による開封があるように見える可能性があります。 つまり、購読者の習慣の変化に正しく対応できないと、送信者のレピュテーションが損なわれ、ひいては成功全体に悪影響が及ぶ可能性があります。
