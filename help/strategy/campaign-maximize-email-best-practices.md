...
メールマーケティングは、ブランドロイヤルティの構築と売上の増加に役立つツールです。 ただし、膨大な数のメールが毎日届くということは、他のデジタルコンテンツは言うまでもなく、大量のコンテンツの中で自分のコンテンツを際立たせることが重要だということです。 そして、コンテンツがオーディエンス固有のニーズを満たすことが重要です。
...
インターネット上ではわずか 1 分で、100 万本を超えるビデオが視聴され、200 万件を超えるGoogle検索クエリが実行され、600 万回を超える Facebook 閲覧が行われ、2 億通を超えるメールが送信されていることをご存知ですか。 このような状況が続く中で、コンテンツがノイズに埋もれないようにすることが重要です。 特に、ホリデーシーズンにキャンペーンを作成する場合、見込み客とリピート客の前にメールを届けるのはさらに困難です。
...
* 新規購読者にウェルカムメールを送信します。
   * ウェルカムメールは、新しいコンテンツが購読者に唐突に届き、配信登録が解除されたり、スパムとしてマークされたりするのを防ぐうえで役に立ちます。
...
戦略とソートリーダーシップについて詳しくは、[カスタマーサクセス](https://experienceleague.adobe.com/ja/docs/customer-success/customer-success/overview)ハブを参照してください。
