    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Personalize your content in Campaign">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/content/dynamic-content/personalize" target="_blank" rel="referrer" title="Campaign でのコンテンツのパーソナライズ"> キャンペーンでコンテンツをパーソナライズ </a>
                    </p>
...
Adobe Campaignには、[標準レポート &#x200B;](https://experienceleague.adobe.com/ja/docs/campaign-web/v8/reports/standard-reports/gs-reports)の3種類があります。
