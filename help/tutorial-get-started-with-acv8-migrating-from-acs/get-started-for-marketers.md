            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/gs-campaigns" title="キャンペーンの基本を学ぶ" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://experienceleague.adobe.com/en/docs/campaign-web/v8/campaigns/gs-campaigns./media_108a52b5751b82e70c440c0869437a46f10e8c605.png?width=400&format=png&optimize=medium" alt="キャンペーンの基本を学ぶ"
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/manage-campaigns" title="キャンペーンへのアクセスと管理" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://experienceleague.adobe.com/en/docs/campaign-web/v8/campaigns/manage-campaigns./media_15156452ddedd42f1da7fd70c7da44e3d45eff1cf.png?width=400&format=png&optimize=medium" alt="キャンペーンへのアクセスと管理"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/create-campaigns" title="最初のキャンペーンを作成" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://experienceleague.adobe.com/en/docs/campaign-web/v8/campaigns/create-campaigns./media_1560eba2c53211ec8eaafc1aafe682276770f5990.png?width=400&format=png&optimize=medium" alt="最初のキャンペーンを作成"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
...
<div class="columns">
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Personalize your content in Campaign">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/campaign-web/v8/content/dynamic-content/personalize" title="Campaign でのコンテンツのパーソナライズ" target="_blank" rel="referrer">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/campaign-web/v8/content/dynamic-content/personalize" target="_blank" rel="referrer" title="Campaign でのコンテンツのパーソナライズ">Campaign でのコンテンツのパーソナライズ </a>
                    </p>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Create conditional content">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/campaign-web/v8/content/dynamic-content/conditions" title="条件付きコンテンツの作成" target="_blank" rel="referrer">
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Work with content templates">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/campaign-web/v8/content/manage-reusable-content/content-templates/create-email-templates" title="コンテンツテンプレートの操作" target="_blank" rel="referrer">
...
Adobe Campaignには、次の 3 種類の [&#x200B; 標準レポート &#x200B;](https://experienceleague.adobe.com/en/docs/campaign-web/v8/reports/standard-reports/gs-reports) があります。
...
<div class="columns">
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Delivery Reports">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/campaign-web/v8/reports/standard-reports/delivery-report/delivery-reports" title="配信レポート" target="_blank" rel="referrer">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/campaign-web/v8/reports/standard-reports/delivery-report/delivery-reports" target="_blank" rel="referrer" title="配信レポート"> 配信報告書 </a>
                    </p>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Campaign Reports">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/campaign-web/v8/reports/standard-reports/campaign-report/campaign-reports" title="キャンペーンレポート" target="_blank" rel="referrer">
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Global Reports">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/campaign-web/v8/reports/standard-reports/global-report/global-reports" title="グローバルレポート" target="_blank" rel="referrer">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/campaign-web/v8/reports/standard-reports/global-report/global-reports" target="_blank" rel="referrer" title="グローバルレポート"> グローバル報告書 </a>
                    </p>
