...
<!-- CARDS
* https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/gs-campaigns
* https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/manage-campaigns
{title = Access and manage your campaigns}
{description = Understand to access and manage campaigns}
* https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/create-campaigns
...
<div class="columns">
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/gs-campaigns" title="キャンペーンの基本を学ぶ" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/gs-campaigns./media_108a52b5751b82e70c440c0869437a46f10e8c605.png?width=400&format=png&optimize=medium" alt="キャンペーンの基本を学ぶ"
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/gs-campaigns" target="_blank" rel="referrer" title="キャンペーンの基本を学ぶ"> キャンペーンの概要 </a>
                    </p>
                    <p class="is-size-6">クロスチャネルキャンペーンを開始する方法を学ぶ</p>
                </div>
                <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/gs-campaigns" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Access and manage your campaigns">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/manage-campaigns" title="キャンペーンへのアクセスと管理" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/manage-campaigns./media_15156452ddedd42f1da7fd70c7da44e3d45eff1cf.png?width=400&format=png&optimize=medium" alt="キャンペーンへのアクセスと管理"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/manage-campaigns" target="_blank" rel="referrer" title="キャンペーンへのアクセスと管理"> キャンペーンへのアクセスと管理 </a>
                    </p>
                    <p class="is-size-6">キャンペーンへのアクセスと管理について</p>
                </div>
                <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/manage-campaigns" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold"> 詳細情報 </span>
                </a>
            </div>
        </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Create your first campaign">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/create-campaigns" title="最初のキャンペーンを作成" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/create-campaigns./media_1560eba2c53211ec8eaafc1aafe682276770f5990.png?width=400&format=png&optimize=medium" alt="最初のキャンペーンを作成"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/create-campaigns" target="_blank" rel="referrer" title="最初のキャンペーンを作成">最初のキャンペーンを作成</a>
                    </p>
                    <p class="is-size-6">新しいキャンペーンを作成するには、その設定を定義し、ワークフローと配信をスケジュールして含めます。</p>
                </div>
                <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/campaigns/create-campaigns" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold"> 詳細情報 </span>
                </a>
            </div>
        </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">配信をスケジュール設定する方法について説明します</p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">配信ログの監視方法について説明します</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Personalize your content in Campaign">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/content/dynamic-content/personalize" target="_blank" rel="referrer" title="Campaign でのコンテンツのパーソナライズ">Campaign でのコンテンツのパーソナライズ </a>
                    </p>
                    <p class="is-size-6">Adobe Campaign Web でのコンテンツのパーソナライズ方法について説明します</p>
                </div>
                <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/content/dynamic-content/personalize" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold"> 詳細情報 </span>
                </a>
            </div>
        </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Create conditional content">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/content/dynamic-content/conditions" target="_blank" rel="referrer" title="条件付きコンテンツの作成"> 条件付きコンテンツの作成 </a>
                    </p>
                    <p class="is-size-6">Adobe Campaign Web でコンテンツをパーソナライズするための条件を定義する方法について説明します</p>
                </div>
                <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/content/dynamic-content/conditions" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold"> 詳細情報 </span>
                </a>
            </div>
        </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Work with content templates">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/content/manage-reusable-content/content-templates/create-email-templates" target="_blank" rel="referrer" title="コンテンツテンプレートの操作">コンテンツテンプレートの操作</a>
                    </p>
                    <p class="is-size-6">Adobe Campaign のメールのコンテンツを再利用するためのテンプレートを作成する方法について説明します</p>
                </div>
                <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/content/manage-reusable-content/content-templates/create-email-templates" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold"> 詳細情報 </span>
                </a>
            </div>
        </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Get started with content fragments">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/content/manage-reusable-content/fragments/fragments" target="_blank" rel="referrer" title="コンテンツフラグメントの基本を学ぶ"> コンテンツフラグメントの概要 </a>
                    </p>
                    <p class="is-size-6">コンテンツフラグメントの作成方法について説明します</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Add offers in your messages">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/msg/offers" target="_blank" rel="referrer" title="メッセージにオファーを追加"> メッセージへのオファーの追加 </a>
                    </p>
                    <p class="is-size-6">オファーを追加して送信する方法を学ぶ</p>
                </div>
...
Adobe Campaignには、次の 3 種類の [&#x200B; 標準レポート &#x200B;](https://experienceleague.adobe.com/ja/docs/campaign-web/v8/reports/standard-reports/gs-reports) があります。
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Delivery Reports">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/reports/standard-reports/delivery-report/delivery-reports" target="_blank" rel="referrer" title="配信レポート"> 配信報告書 </a>
                    </p>
                    <p class="is-size-6">成功率、オーディエンスのエンゲージメント、その他の重要な指標など、各配信のチャネルごとのパフォーマンスを完全に分析します。キャンペーンの全体的な有効性と影響を評価できます。</p>
                </div>
                <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/reports/standard-reports/delivery-report/delivery-reports" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold"> 詳細情報 </span>
                </a>
            </div>
        </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Campaign Reports">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/reports/standard-reports/campaign-report/campaign-reports" target="_blank" rel="referrer" title="キャンペーンレポート"> キャンペーンレポート </a>
                    </p>
                    <p class="is-size-6">個々の配信のパフォーマンス、有効性、結果に関する詳細情報が提供され、包括的な概要が得られます。</p>
                </div>
                <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/reports/standard-reports/campaign-report/campaign-reports" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold"> 詳細情報 </span>
                </a>
            </div>
        </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Global Reports">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/reports/standard-reports/global-report/global-reports" target="_blank" rel="referrer" title="グローバルレポート"> グローバル報告書 </a>
                    </p>
                    <p class="is-size-6">Campaign インスタンス内の各チャネルについて、トラフィックとエンゲージメント指標を連結した全体的な概要を提供します。これらのレポートは様々なウィジェットで構成され、それぞれがキャンペーンや配信パフォーマンスに関する明確な観点を提供します。</p>
                </div>
                <a href="https://experienceleague.adobe.com/ja/docs/campaign-web/v8/reports/standard-reports/global-report/global-reports" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold"> 詳細情報 </span>
                </a>
            </div>
        </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Adobe Experience Manager Assets as a Cloud Service を使用してアセットを管理する方法を学ぶ</p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Adobe Experience Manager as a Cloud Service でのコンテンツの管理方法について説明します</p>
                </div>
...
<div class="columns">
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Work with Campaign and Adobe Analytics">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/campaign/campaign-v8/connect/ac-aa" target="_blank" rel="referrer" title="Campaign と Adobe Analytics の操作">Campaign とAdobe Analyticsの連携 </a>
                    </p>
                    <p class="is-size-6">Campaign と Analytics の統合方法を学ぶ</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Sharing audiences with Adobe Experience Cloud">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/ja/docs/campaign-classic/using/integrating-with-adobe-experience-cloud/audience-sharing/sharing-audiences-with-adobe-experience-cloud" title="オーディエンスを Adobe Experience Cloud と共有する" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://cdn.experienceleague.adobe.com/thumb/exl-cards/documentation.png" alt="オーディエンスを Adobe Experience Cloud と共有する"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/campaign-classic/using/integrating-with-adobe-experience-cloud/audience-sharing/sharing-audiences-with-adobe-experience-cloud" target="_blank" rel="referrer" title="オーディエンスを Adobe Experience Cloud と共有する">オーディエンスを Adobe Experience Cloud と共有する</a>
                    </p>
                    <p class="is-size-6">オーディエンスを Adobe Experience Cloud と共有する</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Work with Campaign and Adobe Target">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/campaign/campaign-v8/connect/ac-at" target="_blank" rel="referrer" title="Campaign と Adobe Target の連携">Campaign とAdobe Targetの連携 </a>
                    </p>
                    <p class="is-size-6">Campaign と Adobe Target の連携方法について説明します</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Work with Campaign and Adobe Experience Cloud triggers">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/ja/docs/campaign/campaign-v8/connect/ac-triggers" title="Campaign と Adobe Experience Cloud トリガーの使用" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://cdn.experienceleague.adobe.com/thumb/exl-cards/documentation.png" alt="Campaign と Adobe Experience Cloud トリガーの使用"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/campaign/campaign-v8/connect/ac-triggers" target="_blank" rel="referrer" title="Campaign と Adobe Experience Cloud トリガーの使用">Campaign とAdobe Experience Cloudのトリガーの操作 </a>
                    </p>
                    <p class="is-size-6">Campaign と Adobe Experience Cloud トリガーの使用方法を説明します</p>
                </div>
